...
const aliensImg = ['imgs/monster-1.png', 'imgs/monster-2.png', 'imgs/monster-3.png'];
const instructionsText = document.querySelector('.game-instructions');
const startButton = document.querySelector('.start-button');
let alienInterval;
let score;
const somLaser = document.getElementById("somLaser");
...
function moveLaser(laser) {
    let laserInterval = setInterval(() => {
        ...
        aliens.forEach((alien) => { // comparando se cada alien foi atingido, se sim, troca o src da img
